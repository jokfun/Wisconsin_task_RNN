...
class Force:
    ...
    def __init__(self,shape,sparsity=0.25,spectral_Radius=1.0,alpha=1.,leak=1.0,_stimulus_length_warm_up=2,
                ...
                sparsityin=1.0,sparsityrw=1.0,sparsitychoice=1.0,choicescale=1.,minchoice=0.5):
        """
    ...
    def train(self,data):
        ...
        for i in range(0,len(data)):
            for k in range(self.stimulus_length_training+self._stimulus_length_warm_up):
                ...
                if k >= self._stimulus_length_warm_up:                    
                    """
        ...
        #compute the rmse
        mse = []
        desired = np.repeat(desired, (self.stimulus_length_training+self._stimulus_length_warm_up), axis = 0)
        """
